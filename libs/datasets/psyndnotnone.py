...
@register_dataset("psyndnotnone")
class PSYNDDataset(Dataset):
    def __init__(
        self,
        ...
        # file path
        assert os.path.exists(audio_feat_folder) and os.path.exists(json_file)
    ...
    def _load_json_db(self, json_file):
        ...
        for key,value in json_db.items():
            ...
            feat_file = os.path.join(self.audio_feat_folder, value['split'].lower(),
            ...
            if self.default_fps is not None:
                ...
                fps = value['feature_frames'] / value['duration']
            else:
    ...
    def __getitem__(self, idx):
        ...
        filename = os.path.join(self.audio_feat_folder,video_item['split'],
